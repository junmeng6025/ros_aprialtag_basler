...
# def make_posemat_msg(pose_mat, w=4, h=4):
#     poses_msg = Float32MultiArray()
#     poses_msg.layout.dim.append(MultiArrayDimension())
#     poses_msg.layout.dim.append(MultiArrayDimension())
#     poses_msg.layout.dim[0].label = "height"
#     poses_msg.layout.dim[1].label = "width"
#     poses_msg.layout.dim[0].size = h
#     poses_msg.layout.dim[1].size = w
#     poses_msg.layout.dim[0].stride = w*h
#     poses_msg.layout.dim[1].stride = w
#     poses_msg.layout.data_offset = 0
#     poses_msg.data = pose_mat
#     pass
